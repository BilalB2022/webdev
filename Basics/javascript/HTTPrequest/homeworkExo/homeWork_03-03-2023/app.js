...
// "https://csclub.uwaterloo.ca/~phthakka/1pt/addURL.php?url=https://www.youtube.com/watch?v=gIOHSAfJ4_s

// short url : https://1pt.co/7sfdz
...
async function MakeShortURL() {
    ...
    */
    ...
    let data = res.json() // retrived response data
    // console.log(data) // data(response object) is ready
